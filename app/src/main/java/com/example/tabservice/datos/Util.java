...
public class Util {
    ...
    public static final String CODIGO_EMPRESA = "6098369-7";
    public static final String GRUPO_TORRE="grupo";
    public static final String ID_USUARIO = "id_usuario";

    public final static int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    public final static String SENDER_ID = "448055700844";
    //192.168.1.124  http://sigti.co/directv/
    public static String base_url = "http://192.168.0.13/directo/"; //192.168.0.13
    //public static String base_url = "http://192.168.1.124/directv/";
    //public static String base_url = "http://192.168.0.13/directv/";
